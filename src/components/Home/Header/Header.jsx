...
export const Header = () => {
  return (
    <header className='flex flex-col lg:flex-row  justify-center items-center gap-14 lg:gap-20 mt-6 lg:mt-10'>
        <div className='flex flex-col w-9/12 lg:w-3/12 gap-3'>
            ...
            <p className='font-rubik text-black text-xl md:text-3xl 2xl:text-4xl font-light mt-4'>¿Te atreves a lograr tus sueños? Únete a esta causa</p>
